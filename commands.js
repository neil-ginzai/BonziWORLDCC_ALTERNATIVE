...
module.exports.markUpName = markUpName;			if (hat === "megatron" && (user.level >= 3 || user.room.ownerID === user.public.guid)) {
				newHats.push("megatron");
			}
			//fixed so that it wont fuck up the server.. (probably..............)
			/*because
...
module.exports.markup = markup;
module.exports.markUpName = markUpName;			let hat = hatList[i];
